...
module attributes {gpu.container_module} {
  ...
  gpu.module @compute_kernel [#nvvm.target<O = 3, chip = "sm_120">] {
  ...
  gpu.module @compute_kernel_0 [#nvvm.target<O = 3, chip = "sm_120">] {
  ...
  gpu.module @compute_kernel_1 [#nvvm.target<O = 3, chip = "sm_120">] {
  ...
  gpu.module @compute_kernel_2 [#nvvm.target<O = 3, chip = "sm_120">] {
